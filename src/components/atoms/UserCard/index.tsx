...
export default function UserCard({userName, userImage}: UserCardProps) {
  return (
	<div className="h-[150px] rounded-2xl bg-gradient-to-r from-red-500 to-red-900 flex items-center p-5 gap-3 relative md:h-[278px] md:flex-col md:justify-center">
